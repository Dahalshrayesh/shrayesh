...
import 'package:Shrayesh_music/Helpers/picker.dart';
import 'package:Shrayesh_music/Services/ext_storage_provider.dart';
...
class _BackupAndRestorePageState extends State<BackupAndRestorePage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/Shrayesh-Music/Backups',
  ) as String;
              ...
              trailing: TextButton(
                ...
                onPressed: () async {
                  autoBackPath = await ExtStorageProvider.getExtStorage(
                        dirName: 'Shrayesh-Music/Backups',
                        writeAccess: true,
                      ) ??
                      '/storage/emulated/0/Shrayesh-Music/Backups';
