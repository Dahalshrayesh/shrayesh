...
import 'package:Shrayesh_music/Screens/Settings/app_ui.dart';
import 'package:Shrayesh_music/Screens/Settings/backup_and_restore.dart';
import 'package:Shrayesh_music/Screens/Settings/download.dart';
import 'package:Shrayesh_music/Screens/Settings/music_playback.dart';
import 'package:Shrayesh_music/Screens/Settings/others.dart';
import 'package:Shrayesh_music/Screens/Settings/theme.dart';
  ...
  Widget _settingsItem(BuildContext context) {
    final List<Map<String, dynamic>> settingsList = [
      ...
      },
      {
        ...
        'isThreeLine': false,
        'items': [
          AppLocalizations.of(context)!.tgGp,
